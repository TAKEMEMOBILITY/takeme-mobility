      ...
      <header className="border-b border-[#F5F5F7]">
        <div className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-5 lg:px-10">
          <Link href="/" className="text-[18px] tracking-[0.01em] text-[#1D1D1F]">
            ...
            <span className="ml-[5px] font-light text-[#8E8E93]">Connect</span>
          </Link>
          <Link href="/" className="text-[14px] font-medium text-[#86868B] hover:text-[#1D1D1F]">
            Back to home
          </Link>
        </div>
      </header>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6">
              {[
                ...
                <div key={stat.label}>
                  ...
                  <p className="text-[12px] font-medium uppercase tracking-wider text-[#86868B]">{stat.label}</p>
                </div>
              ))}
            </div>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ...
              <div key={f.title} className="rounded-2xl bg-white p-6">
                ...
                <p className="mt-2 text-[14px] leading-[1.6] text-[#86868B]">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
