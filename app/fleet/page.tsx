    ...
    <>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <nav style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <Link href="/fleet" style={{ fontFamily: "'DM Sans', sans-serif", color: '#1d1d1f', textDecoration: 'none', fontSize: '0.9rem' }}>
                Browse Vehicles
              </Link>
              <Link href="/fleet/list-your-ev" style={{ fontFamily: "'DM Sans', sans-serif", color: '#1d1d1f', textDecoration: 'none', fontSize: '0.9rem' }}>
                List Your EV
              </Link>
              <Link href="/fleet/dashboard" style={{ fontFamily: "'DM Sans', sans-serif", color: '#1d1d1f', textDecoration: 'none', fontSize: '0.9rem' }}>
                Driver Dashboard
              </Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <Link href="/support" style={{ fontFamily: "'DM Sans', sans-serif", color: '#1d1d1f', textDecoration: 'none', fontSize: '0.9rem' }}>
                Support
              </Link>
              <Link href="/terms" style={{ fontFamily: "'DM Sans', sans-serif", color: '#1d1d1f', textDecoration: 'none', fontSize: '0.9rem' }}>
                Terms
              </Link>
            </nav>
          </div>
        ...
        <div style={{
          ...
          &copy; {new Date().getFullYear()} TakeMe Fleet. All rights reserved.
        </div>
      </footer>
    </>
  )
