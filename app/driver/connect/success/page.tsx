    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-6">
      <div className="max-w-sm text-center">
        ...
        <div className="mt-8 space-y-3">
          <Link href="/driver" className="flex w-full items-center justify-center rounded-2xl bg-[#1D1D1F] py-4 text-[16px] font-semibold text-white hover:bg-[#333]">
            Go to Driver Hub
          </Link>
          <Link href="/" className="flex w-full items-center justify-center rounded-2xl border border-[#E5E5EA] py-4 text-[16px] font-semibold text-[#1D1D1F] hover:bg-[#F5F5F7]">
            Back to home
          </Link>
        </div>
      </div>
